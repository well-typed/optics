...
-- |__Getters__                                                                            |
-- +-----------------------------------+---------------------------------------------------+
-- |'to'                               |Build a 'Getter' from a plain function.            |
-- +-----------------------------------+---------------------------------------------------+
-- |'view' / '^.'                      |View a single target.                              |
-- +-----------------------------------+---------------------------------------------------+
-- |'views'                            |View after applying a function.                    |
-- +-----------------------------------+---------------------------------------------------+
-- |                                                                                       |
-- +-----------------------------------+---------------------------------------------------+
-- |__Setters__                                                                            |
-- +-----------------------------------+---------------------------------------------------+
-- |'sets'                             |Build a 'Setter' from an update function.          |
-- +-----------------------------------+---------------------------------------------------+
-- |'mapped'                           |Build a 'Setter' from the 'Functor' class.         |
-- +-----------------------------------+---------------------------------------------------+
...
-- |__Folds__                                                                              |
-- +-----------------------------------+---------------------------------------------------+
-- |'folded'                           |Build a 'Fold' from the 'Foldable' class.          |
-- +-----------------------------------+---------------------------------------------------+
...
-- |__AffineFolds__                                                                        |
-- +-----------------------------------+---------------------------------------------------+
-- | 'afolding'                        |Build an 'AffineFold' from a partial function.     |
-- +-----------------------------------+---------------------------------------------------+
-- |'preview' / '^?'                   |Match the target or return 'Nothing'.              |
-- +-----------------------------------+---------------------------------------------------+
...
-- |__Traversals__                                                                         |
-- +-----------------------------------+---------------------------------------------------+
-- |'traversed'                        |Build a 'Traversal' from the 'Traversable' class.  |
-- +-----------------------------------+---------------------------------------------------+
-- |'traverseOf'                       |Update target(s) with an 'Applicative'.            |
-- +-----------------------------------+---------------------------------------------------+
-- |                                                                                       |
-- +-----------------------------------+---------------------------------------------------+
-- |__Prisms__                                                                             |
...
-- |__IxGetters__                                                                          |
-- +-----------------------------------+---------------------------------------------------+
-- |'ito'                              |Build an 'IxGetter' from a function returning an   |
-- |                                   |index and value.                                   |
-- +-----------------------------------+---------------------------------------------------+
-- |'iview'                            |View the index and value.                          |
-- +-----------------------------------+---------------------------------------------------+
-- |'iviews'                           |View a function of the index and value.            |
-- +-----------------------------------+---------------------------------------------------+
-- |                                                                                       |
-- +-----------------------------------+---------------------------------------------------+
-- |__IxSetters__                                                                          |
-- +-----------------------------------+---------------------------------------------------+
-- |'isets'                            |Build an 'IxSetter' from a function.               |
-- +-----------------------------------+---------------------------------------------------+
-- |'imapped'                          |Build an 'IxSetter' from the 'FunctorWithIndex'    |
-- |                                   |class.                                             |
-- +-----------------------------------+---------------------------------------------------+
...
-- |__IxFolds__                                                                            |
-- +-----------------------------------+---------------------------------------------------+
-- |'ifolded'                          |Build an 'IxFold' from the 'FoldableWithIndex'     |
-- |                                   |class.                                             |
-- +-----------------------------------+---------------------------------------------------+
-- |'itoListOf'                        |Return a list of (index, target) pairs.            |
-- +-----------------------------------+---------------------------------------------------+
-- |                                                                                       |
-- +-----------------------------------+---------------------------------------------------+
-- |__IxAffineFolds__                                                                      |
-- +-----------------------------------+---------------------------------------------------+
-- |'iafolding'                        |Build an 'IxAffineFold' from a partial function    |
-- |                                   |that returns an (index, target) pair.              |
-- +-----------------------------------+---------------------------------------------------+
-- |'ipreview'                         |Match the index and target or return 'Nothing'.    |
-- +-----------------------------------+---------------------------------------------------+
-- |'ipreviews'                        |Preview a function of the index and target.        |
-- +-----------------------------------+---------------------------------------------------+
-- |                                                                                       |
-- +-----------------------------------+---------------------------------------------------+
-- |__IxTraversals__                                                                       |
-- +-----------------------------------+---------------------------------------------------+
-- |'itraversed'                       |Build an 'IxTraversal' from the                    |
-- |                                   |'TraversableWithIndex' class.                      |
-- +-----------------------------------+---------------------------------------------------+
