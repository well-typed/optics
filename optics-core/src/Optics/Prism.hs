...
aside :: Is k A_Prism => Optic k i i s t a b -> Prism i (e, s) (e, t) (e, a) (e, b)
aside k =
  withPrism k     $ \bt seta ->
  prism (fmap bt) $ \(e,s) ->
  case seta s of
...
without
  ...
  => Optic k i i s t a b
  -> Optic l i i u v c d
  -> Prism i (Either s u) (Either t v) (Either a c) (Either b d)
without k =
...
isn't :: Is k A_Prism => Optic k i i s t a b -> s -> Bool
isn't k s =
...
matching :: Is k A_Prism => Optic k i i s t a b -> s -> Either t a
