...
-----------------------------------------------------------------------------
-- |
-- Module      :  Optics.Generic.Sum.Constructors
...
import Optics.Internal.Generic.Sum.Constructors
import Optics.Prism
...
-- the one between 'Optics.Generic.Product.Fields.HasField' and
-- 'Optics.Generic.Product.Fields.HasField_'.  See
...
instance
  ...
  _Ctor' = genericPrism $ _GCtor @ctor
  {-# INLINE _Ctor' #-}
...
instance
  ...
  _Ctor0 = genericPrism $ _GCtor @ctor
  {-# INLINE _Ctor0 #-}
