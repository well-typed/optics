...
folded :: Foldable f => Fold i (f a) a
folded = Optic (contrasecond (\_ -> ()) . wander traverse_)
{-# INLINE folded #-}

folding :: Foldable f => (s -> f a) -> Fold i s a
