...
"lazy text__ -> foldr"
  forall (o :: Forget r l j Char Char). text__ o = foldring__ Text.foldr (reForget o)
    :: Forget r l (Int -> j) Text Text

"lazy text__ -> ifoldr"
  forall (o :: IxForget r l j Char Char). text__ o = ifoldring__ ifoldrLazy o
    :: IxForget r l (Int -> j) Text Text

"lazy text__ -> map"
  forall (o :: FunArrow l j Char Char). text__ o
                                    = roam Text.map (reFunArrow o)
    :: FunArrow l (Int -> j) Text Text

"lazy text__ -> imap"
  forall (o :: IxFunArrow l j Char Char). text__ o = iroam imapLazy o
