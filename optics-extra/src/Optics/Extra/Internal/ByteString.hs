...
traversedStrictTree__
  :: Traversing p
  => Optic__ p j ci (Int64 -> j) ci B.ByteString B.ByteString Word8 Word8
...
"bytes -> map"
  forall (o :: FunArrow j ci Word8 Word8). traversedStrictTree__ o
                                         = roam B.map (reFunArrow o)
    :: FunArrow (Int64 -> j) ci B.ByteString B.ByteString

"bytes -> imap"
  forall (o :: IxFunArrow j ci Word8 Word8). traversedStrictTree__ o = iroam imapB o
    :: IxFunArrow (Int64 -> j) ci B.ByteString B.ByteString

"bytes -> foldr"
  forall (o :: Forget r j ci Word8 Word8). traversedStrictTree__ o
                                         = foldring__ B.foldr (reForget o)
    :: Forget r (Int64 -> j) ci B.ByteString B.ByteString

"bytes -> ifoldr"
  forall (o :: IxForget r j ci Word8 Word8). traversedStrictTree__ o
                                           = ifoldring__ ifoldrB o
    :: IxForget r (Int64 -> j) ci B.ByteString B.ByteString
...
traversedStrictTree8__
  :: Traversing p
  => Optic__ p j ci (Int64 -> j) ci B8.ByteString B8.ByteString Char Char
...
"chars -> map"
  forall (o :: FunArrow j ci Char Char). traversedStrictTree8__ o
                                       = roam B8.map (reFunArrow o)
    :: FunArrow (Int64 -> j) ci B8.ByteString B8.ByteString

"chars -> imap"
  forall (o :: IxFunArrow j ci Char Char). traversedStrictTree8__ o = iroam imapB8 o
    :: IxFunArrow (Int64 -> j) ci B8.ByteString B8.ByteString

"chars -> foldr"
  forall (o :: Forget r j ci Char Char). traversedStrictTree8__ o
                                       = foldring__ B8.foldr (reForget o)
    :: Forget r (Int64 -> j) ci B8.ByteString B8.ByteString

"chars -> ifoldr"
  forall (o :: IxForget r j ci Char Char). traversedStrictTree8__ o
                                         = ifoldring__ ifoldrB8 o
    :: IxForget r (Int64 -> j) ci B8.ByteString B8.ByteString
...
traversedLazy__
  :: Traversing p
  => Optic__ p j ci (Int64 -> j) ci BL.ByteString BL.ByteString Word8 Word8
...
"sets lazy bytestring"
  forall (o :: FunArrow j ci Word8 Word8). traversedLazy__ o
                                         = roam BL.map (reFunArrow o)
    :: FunArrow (Int64 -> j) ci BL.ByteString BL.ByteString

"isets lazy bytestring"
  forall (o :: IxFunArrow j ci Word8 Word8). traversedLazy__ o = iroam imapBL o
    :: IxFunArrow (Int64 -> j) ci BL.ByteString BL.ByteString

"gets lazy bytestring"
  forall (o :: Forget r j ci Word8 Word8). traversedLazy__ o
                                         = foldring__ BL.foldr (reForget o)
    :: Forget r (Int64 -> j) ci BL.ByteString BL.ByteString

"igets lazy bytestring"
  forall (o :: IxForget r j ci Word8 Word8). traversedLazy__ o = ifoldring__ ifoldrBL o
    :: IxForget r (Int64 -> j) ci BL.ByteString BL.ByteString
...
traversedLazy8__
  :: Traversing p
  => Optic__ p j ci (Int64 -> j) ci BL.ByteString BL.ByteString Char Char
...
"sets lazy char bytestring"
  forall (o :: FunArrow j ci Char Char). traversedLazy8__ o
                                       = roam BL8.map (reFunArrow o)
    :: FunArrow (Int64 -> j) ci BL8.ByteString BL8.ByteString

"isets lazy char bytestring"
  forall (o :: IxFunArrow j ci Char Char). traversedLazy8__ o = iroam imapBL8 o
    :: IxFunArrow (Int64 -> j) ci BL8.ByteString BL8.ByteString

"gets lazy char bytestring"
  forall (o :: Forget r j ci Char Char). traversedLazy8__ o
                                       = foldring__ BL8.foldr (reForget o)
    :: Forget r (Int64 -> j) ci BL8.ByteString BL8.ByteString

"igets lazy char bytestring"
  forall (o :: IxForget r j ci Char Char). traversedLazy8__ o = ifoldring__ ifoldrBL8 o
    :: IxForget r (Int64 -> j) ci BL.ByteString BL.ByteString
